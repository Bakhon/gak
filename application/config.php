<?php
    ...
    /*Изображения*/
    define("HTTP_NO_IMAGE_USER", IMAGE_PATH."no_avatar.png");    //Если нету аватарки
    ...
    define('DB_USERNAME', 'sait');
    define('DB_PASS', 'Gak_astana2018');
    define('DB_DATABASE', 'orcl');
    define('DB_HOST', '192.168.5.41');
    //define('DB_HOST', '192.168.5.171');
